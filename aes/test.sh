...
cat data/tmp | ./aes -d \
-k $(cat data/key_aes_128_cbc_001) -i $(cat data/iv_aes_128_cbc_001) -m cbc | ./pkcs7 -o > data/out
...
cat data/tmp | ./aes -d \
-k $(cat data/key_aes_128_cbc_002) -i $(cat data/iv_aes_128_cbc_002) -m cbc | ./pkcs7 -o > data/out
